...
function handleClick( /* MouseEvent */e) {
  lastClickedFeatureIds = e.features.map(function (f) {
    return f.placeId;
  });
...
function handleMouseMove( /* MouseEvent */e) {
  lastInteractedFeatureIds = e.features.map(function (f) {
    return f.placeId;
  });
  featureLayer.style = applyStyle;
}
function initMap() {
  return __awaiter(this, void 0, void 0, function () {
    var _a, Map, InfoWindow;
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          return [4 /*yield*/, google.maps.importLibrary('maps')];
        case 1:
          _a = _b.sent(), Map = _a.Map, InfoWindow = _a.InfoWindow;
          ...
          map.addListener('mousemove', function () {
            ...
            if (lastInteractedFeatureIds === null || lastInteractedFeatureIds === void 0 ? void 0 : lastInteractedFeatureIds.length) {
              lastInteractedFeatureIds = [];
              featureLayer.style = applyStyle;
            }
          });
...
function createInfoWindow(event) {
  return __awaiter(this, void 0, void 0, function () {
    var feature, place, content;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          feature = event.features[0];
          if (!feature.placeId) return [2 /*return*/];
          return [4 /*yield*/, feature.fetchPlace()];
        case 1:
          place = _a.sent();
          content = '<span style="font-size:small">Display name: ' + place.displayName + '<br/> Place ID: ' + feature.placeId + '<br/> Feature type: ' + feature.featureType + '</span>';
...
var styleClicked = __assign(__assign({}, styleDefault), {
  fillColor: '#810FCB',
  fillOpacity: 0.5
});
// Style for polygon on mouse move.
var styleMouseMove = __assign(__assign({}, styleDefault), {
  strokeWeight: 4.0
});
// Apply styles using a feature style function.
function applyStyle( /* FeatureStyleFunctionOptions */params) {
  var placeId = params.feature.placeId;
  //@ts-ignore
